...
class CollectionImage(Model):
    ...
    path = models.TextField(null = True, blank = True, max_length=1000)
    path_compressed = models.TextField(null = True, blank = True, max_length=1000)
    metadata = models.TextField(null = True, blank = True, max_length=2000)
