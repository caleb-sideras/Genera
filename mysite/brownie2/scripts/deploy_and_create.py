...
def deploy2(collection_name, collection_symbol, account):
    collectible = NFTGenerator.deploy(collection_name, collection_symbol)
    return collectible
