...
image = 0
# print(texturedAssetDict["Body"])


for i in range(tempDict["Collection Size"]):
    for value in texturedAssetDict:

        asset1 = texturedAssetDict["Body"][i]
        asset2 = texturedAssetDict["Hair"][i]
        asset3 = texturedAssetDict["Shirt"][i]
        asset4 = texturedAssetDict["Accessories"][i]

        # print(asset1, asset2, asset3, asset4)

        im.paste(asset1, (0, 0), asset1)
        im.paste(asset2, (0, 0), asset2)
        im.paste(asset3, (0, 0), asset3)
        im.paste(asset4, (0, 0), asset4)
